...
os.chdir('C:\\Users\\shaln\\python\\Python\\OPEN_CV\\LESSON_6\\Homework\\images')
path = "C:\\Users\\shaln\\python\\Python\\OPEN_CV\\LESSON_6\\Homework\\images"
...
for file in os.listdir('.'):
    if file.endswith('.jpg') or file.endswith('.jpeg') or file.endswith('.png'):
        ...
        #imgResized = img.resize((mean_width, mean_height), Image.ANTIALIAS) #does not work on newer verson
...
def videoGenerator():
    video_name = "FamilyTogetherVideo.avi"
