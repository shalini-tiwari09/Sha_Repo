...
New_img_Sum = cv2.addWeighted(image1, 0.6, image2, 0.5, 0)
...
borderedImage = cv2.copyMakeBorder(img, 10, 10, 10, 10, cv2.BORDER_CONSTANT, value = 100)
